...
m1=np.loadtxt('GN/Model_file.txt')
m2=np.loadtxt('ADMM_FS/Model_file.txt')
m3=np.loadtxt('ADMM_FS/Model_file.txt')
...
plt.subplots_adjust(wspace=0.3,top=0.92,bottom=0.14,right=0.95,left=0.12) 
...
ax1.plot(res_1[:n_l],dep_c,'r-',linewidth=1.0,label='GN')
ax1.plot(res_2[:n_l],dep_c,'b-',linewidth=1.0,label='GN-FS')
ax1.plot(res_3[:n_l],dep_c,'g-',linewidth=1.0,label='ADMM-FS')
ax1.minorticks_on()
...
# ax2.legend(fontsize=8.5,borderaxespad=0.4,frameon=False,ncol=1,labelspacing=0.5)
ax2.legend(fontsize=8.5,borderaxespad=0.1,frameon=False,ncol=1,labelspacing=0.3)
plt.rcParams.update({'font.size': 8})

# fig.subplots_adjust(top=0.97,bottom=0.138,right=0.98,left=0.1)
# ax1.legend(bbox_to_anchor=(1.12, 1.50),ncol=1,loc=9,fontsize=10, frameon=True,edgecolor='black',borderaxespad=0)
