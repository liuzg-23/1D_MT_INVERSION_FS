...
ax2.plot(res_1[n_l:],dep_c,'r-',linewidth=1.0,label=r'$N_{fs}=10$')
ax2.plot(res_2[n_l:],dep_c,'b-',linewidth=1.0,label=r'$N_{fs}=20$')
ax2.plot(res_3[n_l:],dep_c,'g-',linewidth=1.0,label=r'$N_{fs}=30$')
...
ax1.legend(loc=7,fontsize=8.5,borderaxespad=0.4,frameon=False,ncol=1,labelspacing=0.25)
